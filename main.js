...
prefix = '#'
shp = '⬡'
owner = "6285694982557@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.on("qr", () => {
    console.log(
      ...
      color("]", "white"),
      color(" Scan bang"),
      client.sendMessage(`6285694982557@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Berhasil Terhubung!_`, MessageType.extendedText)
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('⎇','red'), color('𝗦𝗰𝗿𝗶𝗽𝘁 𝗜𝗻𝗶 𝗚𝘄 𝗦𝘂𝘀𝘂𝗻 𝗦𝗲𝗻𝗱𝗶𝗿𝗶!\n𝗡𝗼𝘁𝗲: 𝗝𝗮𝗻𝗴𝗮𝗻 𝗟𝘂𝗽𝗮 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲 𝙉𝙖𝙣𝙙𝙖 𝙎𝙩𝙮𝙡𝙚 シ︎ & EmzyBotz', 'yellow'))
    console.log(color('⎇','red'), color('𝗦𝗼𝘂𝗿𝗰𝗲 𝗖𝗼𝗱𝗲 𝗩𝗲𝗿𝘀𝗶𝗼𝗻:', 'aqua'), color(version))
    console.log(color('⎇','red'), color('𝗕𝘂𝗴? 𝗘𝗿𝗿𝗼𝗿? 𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗶𝗼𝗻? 𝗩𝗶𝘀𝗶𝘁 𝗛𝗲𝗿𝗲:', 'aqua'), color('https://wa.me/6285774370647'))
    console.log(color('[NDAABOTZ]'), color('𝗦𝗲𝗹𝗳𝗯𝗼𝘁 EmzyBotz 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6285774370647-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'EmzyBotzシ︎⁩',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;EmzyBotz;;;\nFN:resku\nitem1.TEL;waid=6285774370647:+62 857-7437-0647\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
      ...
      if (anu.action == "promote") {
        ...
        try {
          ...
          ppimg =
            "https://telegra.ph/file/99b5f8554e06388da1bd2.jpg";
        }
