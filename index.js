...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6285774370647@s.whatsapp.net`]
      ...
      message: {
        productMessage: {
          product: {
            productImage: {
              mimetype: "image/jpeg",
              jpegThumbnail: fs.readFileSync(`./stik/thumb.jpeg`), //https://telegra.ph/file/99b5f8554e06388da1bd2.jpg
            },
            title: "FakeReply Bang", //dpin
...
㋛${prefix}upswlokasi
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵??𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
